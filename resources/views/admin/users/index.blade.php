        ...
        <div class="mx-auto max-w-6xl sm:px-6 lg:px-8">
            ...
            <form method="GET" class="mb-4">
                <div class="flex items-center gap-2">
                    ...
                    <select name="status"
                            class="rounded border-gray-300 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-100 text-sm"
                                        ...
                                        @else
                                            ...
                                            @can('users.delete')
                                                <form method="POST" action="{{ route('admin.users.restore', $u->id) }}">
                                                    @csrf @method('PATCH')
                                                    <button class="rounded border px-3 py-1 text-sm dark:border-gray-600">
                                                        Restaurar
                                                    </button>
                                                </form>
                            ...
                            @can('users.update')
                                <x-modal name="editar-usuario-{{ $u->id }}" :show="false" focusable maxWidth="2xl">
                                    <div class="flex flex-col gap-1 p-6 md:p-8">
                                        <form method="POST" action="{{ route('admin.users.update', $u) }}" class="space-y-6 m-4">
                                            @csrf @method('PUT')
                                            ...
                                            {{-- Rodapé --}}
                                            <div class="pt-4 mt-2 flex justify-end gap-2 border-t border-gray-200 dark:border-gray-700">
                                                <button type="button"
                                                ...
                                                <button class="rounded bg-indigo-600 px-3 py-1 text-sm text-white hover:bg-indigo-700">
                                                    Salvar
                                                </button>
                                            </div>
