...
<div class="grid grid-cols-1 gap-5 sm:grid-cols-3">
    ...
    <div>
        ...
        <select id="marca_id" name="marca_id" class="mt-1 block w-full rounded-md border-gray-300 dark:bg-gray-900"
            required>
...
<div class="mt-5">
    ...
    <textarea id="observacao" name="observacao" rows="3"
        class="mt-1 block w-full rounded-md border-gray-300 dark:bg-gray-900">{{ old('observacao', $registro->observacao ?? '') }}</textarea>
...
<div class="mt-6">
    <x-input-label value="Itens verificados" />
    @php
