<form method="POST" action="{{ $action }}" class="space-y-4">
    ...
    <div>
        ...
        <textarea name="descricao" rows="3" class="w-full rounded border px-3 py-2 bg-white dark:bg-gray-900 border-gray-300 dark:border-gray-600">{{ old('descricao', $marca->descricao ?? '') }}</textarea>
    </div> --}}
